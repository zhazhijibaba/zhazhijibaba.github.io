  ...
  const myQuestions = [
    ...
    },
    {
      ...
      answers: {
        a: "<math><mi>3</mi></math>",
        b: "<math><mi>6</mi></math>",
        c: "<math><mi>3</mi><mi>r</mi></math>",
        d: "<math><mi>6</mi><mi>r</mi></math>",
    ...
    {
      question: "For the circle shown with center C, if diameter AB = 4, which of the following is the area of the circle:",
      answers: {
        a: "<math><mi>16</mi></math>",
        b: "<math><mi>32</mi><mi>&pi;</mi></math>",
        c: "<math><mi>16</mi><mi>&pi;</mi></math>",
    ...
    {
      question: "Figure 1 shown represents the wheel on a model with center C. The length of AC = 11cm. If the wheel has made 5 complete revolutions, then, of the following, which is the best estimate for the distance traveled by the wheel?",
      answers: {
        a: "55",
        b: "110",
        c: "165",
    ...
    {
      question: "For the circle shown with center C, if AB = 8 inches, which of the following is the area, in square inches, of the circle?",
      answers: {
        a: "<math><mi>2</mi><mi>&pi;</mi></math>",
        b: "<math><mi>4</mi><mi>&pi;</mi></math>",
        c: "<math><mi>8</mi><mi>&pi;</mi></math>",
    ...
    {
      question: "Figure 1 shown represents the wheel on a model with center C. The length of AB = 2r. If the wheel has made 3 complete revolutions, then, of the following, which is the best estimate for the distance traveled by the wheel?",
      answers: {
        a: "<math><mi>2</mi><mi>r</mi></math>",
        b: "<math><mi>6</mi><mi>r</mi></math>",
        c: "<math><mi>2</mi><mi>&pi;</mi><mi>r</mi></math>",
        d: "<math><mi>6</mi><mi>&pi;</mi><mi>r</mi></math>",
        e: "<math><mi>3</mi><mi>&pi;</mi><msup><mi>r</mi><mi>2</mi></msup></math>"
      },
      correctAnswer: "d"
    }
  ];
